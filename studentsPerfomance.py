...
first_std_deviation_start, first_std_deviation_end = mean-std_deviation, median +std_deviation
...
print("{}% of data lies within 1 standard deviation".format(len(listOfData_within_1_std_deviation)*100.0/len(data)))
print("{}% of data lies within 2 standard deviation".format(len(listOfData_within_2_std_deviation)*100.0/len(data)))
print("{}% of data lies within 3 standard deviation".format(len(listOfData_within_3_std_deviation)*100.0/len(data)))
